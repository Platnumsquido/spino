...
local Window = Rayfield:CreateWindow({
	Name = "GoldWARE Spinbot & Bhop",
	LoadingTitle = "GoldWARE Spinbot & Bhop",
	LoadingSubtitle = "by ChaffyScarab#8677 & discord.gg/P8bqYp5DWw",
	ConfigurationSaving = {
		Enabled = true,
		FolderName = nil, 
		FileName = "Big Hub"
	...
	KeySettings = {
		Title = "GoldWARE",
		Subtitle = "Key System",
		Note = "Join the discord (discord.gg/P8bqYp5DWw)",
		FileName = "SiriusKey",
		SaveKey = true,
